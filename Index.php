...
<div><a href="https://www.instagram.com/leelarosa.mp3/?hl=en"><i class="fab fa-instagram" style="margin-top 50%; padding-top: 35%; font-size: 40px;display: inline-block;"></i></a></div>
<div><a href="#"><i class="fab fa-youtube" style="padding-top: 2%; font-size: 30px; display: inline-block;"></i></a></div>
<div><a href="#"><i class="fab fa-spotify" style="padding-top: 2%; font-size: 35px; display: inline-block;"></i></a></div>
</div>
...
<section>
    ...
    <div id="axis" class="two">
        <img class="object van move-left" style=" z-index: 0;" src="img/Plaathoes.png"/>
    </div>
    </div>   
    <div class="flex-container5">
    <div><button class="button button6">Listen Now</button> </div>
    <div><button class="button button6">Order Now</button> </div>
    </div>
